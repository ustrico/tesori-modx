...
return;',
      'locked' => '0',
      'properties' => 'a:1:{s:16:"albumCommonTitle";a:7:{s:4:"name";s:16:"albumCommonTitle";s:4:"desc";s:0:"";s:4:"type";s:9:"textfield";s:7:"options";a:0:{}s:5:"value";s:1:"q";s:7:"lexicon";N;s:4:"area";s:0:"";}}',
      'disabled' => '0',
      'moduleguid' => '',
      'static' => '0',
      'static_file' => '',
      ...
      'plugincode' => 'switch ($modx->event->name)
{
    ...
    array (
      ...
      'source' => '1',
      'property_preprocess' => '0',
      'name' => 'CopyResWithoutGalleryAlbum',
      'description' => '',
      'editor_type' => '0',
      'category' => '0',
      'cache_type' => '0',
      'plugincode' => 'if ($modx->event->name==\'OnResourceDuplicate\') {
        ...
        $newResource->setTVValue(\'galleryAlbum\', \'\');
}',
      'locked' => '0',
      'properties' => 'a:0:{}',
      'disabled' => '0',
...
return;',
    ...
    array (
      ...
      'source' => '1',
      'property_preprocess' => '0',
      'name' => 'GetToPlaceholders',
      'description' => 'Get-параметры в плейсхолдеры',
      'editor_type' => '0',
      'category' => '0',
      'cache_type' => '0',
      'plugincode' => 'foreach ($_GET as $key => $val) {
