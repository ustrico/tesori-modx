...
$_lang['login_blocked_ip'] = 'Вам запрещено входить в систему управления сайтом с этого IP-адреса.';
$_lang['login_blocked_time'] = 'В настоящее время вам запрещено входить в систему управления сайтом. Пожалуйста, попытайтесь позже.';
...
$_lang['login_password_reset_act_sent'] = 'Письмо для сброса пароля отправлено. Пожалуйста, проверьте почтовый ящик.';
$_lang['login_remember'] = 'Запомнить меня';
$_lang['login_send_activation_email'] = 'Выслать письмо для активации';
$_lang['login_title'] = 'Вход в панель управления MODX CMF';
$_lang['login_user_err_nf_email'] = 'Пользователь с таким адресом электронной почты или именем не найден. Пожалуйста, попробуйте ещё раз.';
$_lang['login_username'] = 'Имя пользователя';
$_lang['login_username_or_email'] = 'Имя пользователя или электронная почта';
$_lang['login_username_password_incorrect'] = 'Неправильный логин или пароль.';
